...
case (index)
0: bram_feature_table=(val_==0)?9:(val_==1)?10:(val_==2)?1:(val_==3)?1:(val_==4)?0:0;
1: bram_feature_table=(val_==0)?10:(val_==1)?5:(val_==2)?1:(val_==3)?1:(val_==4)?0:0;
2: bram_feature_table=(val_==0)?9:(val_==1)?8:(val_==2)?1:(val_==3)?1:(val_==4)?1:0;
3: bram_feature_table=(val_==0)?10:(val_==1)?4:(val_==2)?1:(val_==3)?1:(val_==4)?1:0;
4: bram_feature_table=(val_==0)?11:(val_==1)?2:(val_==2)?1:(val_==3)?1:(val_==4)?1:0;
5: bram_feature_table=(val_==0)?12:(val_==1)?1:(val_==2)?1:(val_==3)?1:(val_==4)?1:0;
   endcase
endfunction  
...
case (index)
   0: bram_decompose_table=(val_==0)?   1:(val_==1)?   1:(val_==2)?   7:(val_==3)?   0:(val_==4)?   0:0;
   endcase
endfunction  
...
case (index)
   ...
   1: bram_mapping_table=(val_== 0)?   0:(val_== 1)?   1:(val_== 2)?   9:(val_== 3)?   5:(val_== 4)?   0:(val_== 5)?   0:(val_== 6)?   0:(val_== 7)?   0:(val_== 8)?   0:(val_== 9)?   9:(val_==10)?   5:(val_==11)?   0:(val_==12)?   0:(val_==13)?   0:(val_==14)?   0:(val_==15)?   0:(val_==16)?  10:(val_==17)?   5:(val_==18)?  10:(val_==19)?   5:0;
   2: bram_mapping_table=(val_== 0)?   0:(val_== 1)?   2:(val_== 2)?  14:(val_== 3)?  10:(val_== 4)?   0:(val_== 5)?   0:(val_== 6)?   0:(val_== 7)?   0:(val_== 8)?   0:(val_== 9)?  14:(val_==10)?  10:(val_==11)?   0:(val_==12)?   0:(val_==13)?   0:(val_==14)?   0:(val_==15)?   0:(val_==16)?  10:(val_==17)?   5:(val_==18)?  10:(val_==19)?   5:0;
   3: bram_mapping_table=(val_== 0)?   0:(val_== 1)?   3:(val_== 2)?  19:(val_== 3)?  15:(val_== 4)?   0:(val_== 5)?   0:(val_== 6)?   0:(val_== 7)?   0:(val_== 8)?   0:(val_== 9)?  19:(val_==10)?  15:(val_==11)?   0:(val_==12)?   0:(val_==13)?   0:(val_==14)?   0:(val_==15)?   0:(val_==16)?  10:(val_==17)?   5:(val_==18)?  10:(val_==19)?   5:0;
   4: bram_mapping_table=(val_== 0)?   0:(val_== 1)?   4:(val_== 2)?  24:(val_== 3)?  20:(val_== 4)?   0:(val_== 5)?   0:(val_== 6)?   0:(val_== 7)?   0:(val_== 8)?   0:(val_== 9)?  24:(val_==10)?  20:(val_==11)?   0:(val_==12)?   0:(val_==13)?   0:(val_==14)?   0:(val_==15)?   0:(val_==16)?  10:(val_==17)?   5:(val_==18)?  10:(val_==19)?   5:0;
   5: bram_mapping_table=(val_== 0)?   0:(val_== 1)?   5:(val_== 2)?  29:(val_== 3)?  25:(val_== 4)?   0:(val_== 5)?   0:(val_== 6)?   0:(val_== 7)?   0:(val_== 8)?   0:(val_== 9)?  29:(val_==10)?  25:(val_==11)?   0:(val_==12)?   0:(val_==13)?   0:(val_==14)?   0:(val_==15)?   0:(val_==16)?  10:(val_==17)?   5:(val_==18)?  10:(val_==19)?   5:0;
   6: bram_mapping_table=(val_== 0)?   0:(val_== 1)?   6:(val_== 2)?  31:(val_== 3)?  30:(val_== 4)?   0:(val_== 5)?   0:(val_== 6)?   0:(val_== 7)?   0:(val_== 8)?   0:(val_== 9)?  31:(val_==10)?  30:(val_==11)?   0:(val_==12)?   0:(val_==13)?   0:(val_==14)?   0:(val_==15)?   0:(val_==16)?  10:(val_==17)?   5:(val_==18)?  10:(val_==19)?   5:0;
   endcase
endfunction  
